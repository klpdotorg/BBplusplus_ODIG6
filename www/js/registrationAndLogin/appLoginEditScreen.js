...
Game.appLoginEditScreen.prototype = {
	...
	create: function (game) {
		...
		_this.basePath = cordova.file.externalRootDirectory + "Android/data/com.Akshara.ODIBBplusplus/Files/Download/.gameFilesBB++V10_2/www/";

		_this.fullSize = 144609760;

        _this.zipFiles = [["Assets1.zip", 565373], ["Assets2.zip", 25572815], ["Assets4.zip", 66105124], ["questionSounds.zip", 48682701], ["sounds.zip", 3683747]];
		//48,682,701 + 9,59,27,059
		...
		if (_this.user.language == "English") {
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/ALAS-01-G6/ODI", "ODI" + "/questionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
	...
	checkIfAllAssetsPresent: function () {
		if (_this.counter < _this.fileCheck.length) {
			...
			window.baseUrl = cordova.file.externalRootDirectory + "Android/data/com.Akshara.ODIBBplusplus/Files/Download/.gameFilesBB++V10_2/www/";//cordova.file.externalDataDirectory + 
		...
		if (navigator.connection.type != "none" && navigator.connection.type != "unknown" && navigator.connection.type != null && navigator.connection.type != "undefined") {
			...
			fileTransfer.onprogress = function (progressEvent) {
                if (progressEvent.lengthComputable) {
                    ...
                    if (filename == "ODI"+ "/questionSounds.zip")
